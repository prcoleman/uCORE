...
urlpatterns = patterns('coreo.ucore.views',
    ...
    url(r'^get-tags/$', 'get_tags', name='get-tags'),
    ...
    url(r'^search/$', 'search', {'models': ('Link', 'LinkLibrary')}, name='search-all'),
    url(r'^search/links/$', 'search', {'models': ('Link',)}, name='search-links'),
    url(r'^search/libraries/$', 'search', {'models': ('LinkLibrary',)}, name='search-libraries'),
    ...
    url(r'^libraries/(?P<libraryId>\d+)', 'get_library_by_id', name='get-library-by-id'),
    ...
    url(r'^keywords/$', 'get_keywords', name='get-keywords'),
